...
var init_dist = __esm({
  "../cms-js-internal/dist/index.js"() {
    ...
    serializeIslandDataForInlineScript = (tweakedIslandsArray, perServerRequestData, baseIndent = 0, prettyPrint) => {
...
${indentString}`);
    ...
    createIslandsGlobalJsForClientInDev = (roots, perServerRequestData, viteDevServer, indent, prettyPrint) => {
